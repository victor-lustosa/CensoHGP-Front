  ...
  constructor(private fatoresService: FatorRiscoService,
    ...
    ngOnInit(): void {
      ...
      this.activatedRoute.params.pipe(
        ...
        switchMap(id => this.fatoresService.getFatoresById(id))
    ...
    saveFatores() {
      ...
      if (this.formulario.valid) {
        if (this.formulario.get('idFatorRisco').value != null) {
          this.fatoresService.updateFatores(this.formulario.value)
          .subscribe(
            sucess => {
              this.formulario,
              this.sucesso = true,
            ...
            this.fatoresService.createFatores(this.formulario.value)
            .subscribe(
              sucess => {
                console.log(sucess),
                this.formulario,
